                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <input type="text" name="news_date" id="news_date" class="datetimepicker form-control" placeholder="Please choose date &amp; time..." value="{{ $news->news_date }}">
                                </div>
                            </div>

                            <div class="form-group">
                                <input type="checkbox" id="publish" class="filled-in" name="status"  {{ $news->status == true ? 'checked' : '' }} >
                            ...
                            <div class="form-group">
                               <h5>
                                 ...
                                 <textarea id="tinymce" name="description">{{ $news->description }}</textarea>
                             </div>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $("#profileImage").fileinput({
            ...
            defaultPreviewContent: '<img src="{{ asset( 'public/images/news/small/'.$news->image )}}" alt="Profile Image" style="width:100%;">',
