                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="title" class="form-control" name="title" value="{{ $photo->title }}">
                                    <label class="form-label">Title*</label>
                                </div>
                            </div>

                            <div class="form-group">
                                <input type="checkbox" id="publish" class="filled-in" name="status" {{ $photo->status == true ? 'checked' : '' }}>
                                <label for="publish">Status</label>
                            </div>
                            <a class="btn btn-danger btn-xs m-t-15 waves-effect" href="{{ route('admin.photo.index') }}"><i class="material-icons">reply_all</i> Back</a>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $("#profileImage").fileinput({
            ...
            defaultPreviewContent: '<img src="{{ asset( 'public/images/photo/small/'.$photo->image )}}" alt="Profile Image" style="width:100%;">',
