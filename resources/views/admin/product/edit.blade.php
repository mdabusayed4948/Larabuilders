                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <textarea rows="4" name="short_description" class="form-control no-resize" placeholder="Short Description*...">{{ $product->short_description }}</textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <input type="checkbox" id="publish" class="filled-in" name="status" {{ $product->status == true ? 'checked' : '' }} >
                            ...
                            <a class="btn btn-danger btn-xs m-t-15 waves-effect" href="{{ route('admin.product.index') }}"><i class="material-icons">reply_all</i> Back</a>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $("#profileImage").fileinput({
            ...
            defaultPreviewContent: '<img src="{{ asset( 'public/images/products/small/'.$product->image )}}" alt="Profile Image" style="width:100%;">',
