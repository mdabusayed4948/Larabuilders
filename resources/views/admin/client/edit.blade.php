                ...
                <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            <div class="form-group form-float">
                                <div class="form-line">
                                    <input type="text" id="designation" class="form-control" name="designation" value="{{ $client->designation }}">
                            ...
                            <div class="form-group">
                                <input type="checkbox" id="publish" class="filled-in" name="status" {{ $client->status == true ? 'checked' : '' }}>
                                <label for="publish">Status</label>
                            </div>

                            <a class="btn btn-danger btn-xs m-t-15 waves-effect" href="{{ route('admin.client.index') }}"><i class="material-icons">reply_all</i> Back</a>
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        $("#profileImage").fileinput({
            ...
            defaultPreviewContent: '<img src="{{ asset( 'public/images/clients/small/'.$client->image )}}" alt="Profile Image" style="width:100%;">',
