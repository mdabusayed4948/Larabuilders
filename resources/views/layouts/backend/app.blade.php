...
<head>
    ...
    <title>@yield('title') | {{ config('app.name', 'Larabuilders') }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('public/assets/backend/fileinput/css/fileinput.min.css') }}">
    <style type="text/css">
        .photo-id{
...
<script src="{{ asset('public/assets/backend/js/pages/ui/tooltips-popovers.js') }}"></script>
<script src="{{ asset('public/assets/backend/fileinput/js/fileinput.min.js') }}"></script>
